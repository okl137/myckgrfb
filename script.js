...
const translations = {
    en: {
        ...
        projects: [
            ...
            {
                title: "mymusicfb",
                desc: "Music Player.<br>Supports web and local playback. Features liquid texture UI for immersive experience.",
                tags: ["Music", "Liquid UI", "Web/Local"]
            },
            {
                title: "myckgrfb",
    ...
    zh: {
        ...
        projects: [
            ...
            {
                title: "mymusicfb",
                desc: "音乐播放器。<br>支持网页端和本地端，液态质感UI，沉浸式音乐体验。",
                tags: ["音乐", "液态UI", "网页/本地"]
            },
            {
                title: "myckgrfb",
